# Dominio de Atención al Cliente

## Propósito y alcance
Resuelve consultas, incidencias y reclamaciones de clientes a lo largo del ciclo de vida del pedido. Actúa como punto de contacto central para coordinar acciones con logística, ventas digitales y contabilidad.

## Equipo y usuarios
- **Equipo de experiencia cliente:** líderes de operaciones, especialistas en soporte y QA de atención.
- **Usuarios internos:** agentes del contact center, supervisores de calidad y analistas de procesos.
- **Usuarios externos:** clientes finales, repartidores que reportan incidencias y representantes de aliados logísticos.
